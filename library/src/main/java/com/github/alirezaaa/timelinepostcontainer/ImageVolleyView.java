...
public class ImageVolleyView extends ImageView {
     ...
     * {@link ImageVolleyView#setDefaultImageResId(int)} on the view.
     * <p/>
     * NOTE: If applicable, {@link ImageVolleyView#setDefaultImageResId(int)} and {@link
     * ImageVolleyView#setErrorImageResId(int)} should be called prior to calling this function.
     *
    ...
    private void loadImageIfNecessary(final boolean isInLayoutPass) {
        ...
        boolean isFullyWrapContent = getLayoutParams() != null
                ...
                && getLayoutParams().width == FrameLayout.LayoutParams.WRAP_CONTENT;
